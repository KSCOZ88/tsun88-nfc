...
module.exports=async function handler(req,res){
  ...
  try{
    ...
    form.set('line_items[0][quantity]',String(itemCount));form.set('line_items[0][price_data][currency]','hkd');form.set('line_items[0][price_data][unit_amount]','9900');form.set('line_items[0][price_data][product_data][name]','尊八八 NFC 宠物狗牌');
